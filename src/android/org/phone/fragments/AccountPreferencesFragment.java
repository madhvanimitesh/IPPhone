...
import org.phone.ui.PreferencesListFragment;
...
//	public
	...
	OnPreferenceChangeListener proxyChangedListener = new OnPreferenceChangeListener() {
		@Override
		public boolean onPreferenceChange(Preference preference, Object newValue) {
//			newValue = "<sip:35.154.8.192;transport=udp>";
			String value = newValue.toString();
//			Toast.makeText(getActivity(),"VALUE = "+ value , Toast.LENGTH_LONG).show();
//			Toast.makeText(getActivity(),"isNewAccount = "+ isNewAccount , Toast.LENGTH_LONG).show();
	...
	private void initAccountPreferencesFields(PreferenceScreen parent) {
		...
		mProxyPreference = (EditTextPreference)
				advanced.getPreference(3);
//		mProxyPreference.setText("<sip:35.154.8.192;transport=udp>");
//		mProxyPreference.setSummary("<sip:35.154.8.192;transport=udp>");
...
//		Toast.makeText(getActivity(),"PROXY GET TEXT=" + mProxyPreference.getText() , Toast.LENGTH_LONG).show();
//		Toast.makeText(getActivity(),"PROXY GET SUMMERY=" + mProxyPreference.getSummary() , Toast.LENGTH_LONG).show();


		CheckBoxPreference outboundProxy = (CheckBoxPreference) advanced.getPreference(4);
//		outboundProxy.setChecked(true);
